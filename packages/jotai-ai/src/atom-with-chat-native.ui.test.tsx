...
describe('initial messages', () => {
  ...
  it('should not cause infinite rerenders', async () => {
    await waitFor(() => {
...
describe('chat instance changes', () => {
  const chatInstAtom = atom<Chat<UIMessage>>(
    new Chat({
      id: 'initial-id',
      generateId: mockId(),
    }),
      ...
      return (
        <div>
          ...
          <button
            ...
            onClick={() => {
              setChat(new Chat({ id: 'second-id', generateId: mockId() }));
            }}
          />
        </div>
      );
